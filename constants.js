// The total height of world in pixels
...
// Randomly placed scenery for background
// Arranged to fill empty spaces of zigzag
...
export const RESULTS = {
  ...
  '2': {
    ...
    strength: "威慑",
    skill: "驱邪避灾",
    desc: "你是抵御负面能量的屏障，原始力量的化身。气场如同不灭的火焰，能守护社群的安宁与纯净。",
    color: "bg-orange-100",
    icon: "🔥"
  },
  '3': {
  ...
  '8': {
    ...
    strength: "连接",
    skill: "通灵对话",
    desc: "你的气质沉静而通透，如同连接天地的白桦。能轻易聆听来自过去与自然的声音，是温柔的灵性媒介。",
    color: "bg-cyan-100",
    icon: "🌙"
  }
};